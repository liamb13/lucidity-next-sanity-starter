 ...
 */
export function defineImageField({ name = 'image', withHotspot = true, withAiAssistAlt = true, withFit = true, withCaption = true, captionFieldType = 'text', } = {}) {
    return defineField({
        title: 'Image',
        name,
        type: 'image',
        ...
        fields: [
            defineField({
                ...
                type: 'string',
                title: 'Alt text',
                description: 'Optional. For screen-readers. Leave blank if the image is purely decorative and holds no contextual information, or if caption is provided.',
            }),
            ...(withCaption
                ? [
                    defineField({
                        ...
                        description: 'Optional. Description of the image displayed on or under the image',
                    }),
                ]
                : []),
            ...(withFit
                ? [
                    defineField({
                        ...
                        title: 'Image fit',
                        type: 'string',
                        description: (_jsxs("details", { children: [_jsx("summary", { children: "What does this mean?" }), "Choose whether you want to crop or shrink images to fit them into their box on the website. If cropped, the image may lose some of the content on its sides. If it shrinks, the entire image will always be visible, but extra spacing may be added on its sides."] })),
                        options: {
                            list: [
                                {
